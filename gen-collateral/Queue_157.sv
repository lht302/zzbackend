...
module Queue_157(
  ...
  input  [54:0] io_enq_bits,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  ...
  output [54:0] io_deq_bits,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  output [4:0]  io_count	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
);
  ...
  wire       do_enq = _io_enq_ready_output & io_enq_valid;	// @[src/main/scala/chisel3/util/Decoupled.scala:52:35]
  wire       _io_deq_valid_output = ~(ptr_match & ~maybe_full);	// @[src/main/scala/chisel3/util/Decoupled.scala:277:27, :278:33, :279:{25,28}, :303:19]
  assign _io_enq_ready_output = ~(ptr_match & maybe_full);	// @[src/main/scala/chisel3/util/Decoupled.scala:277:27, :278:33, :280:24, :304:19]
  wire       do_deq = io_deq_ready & _io_deq_valid_output;	// @[src/main/scala/chisel3/util/Decoupled.scala:52:35]
