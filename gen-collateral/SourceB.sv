...
module SourceB(
  ...
  input  [2:0]  io_req_bits_clients,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceB.scala:35:14]
  ...
  reg  [2:0]  remain;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceB.scala:46:25]
  wire [2:0]  todo = (|remain) ? remain : io_req_bits_clients;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceB.scala:46:25, :51:23, :52:19]
  wire [2:0]  _GEN = {~(todo[1:0] | {todo[0], 1'h0}), 1'h1} & todo;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceB.scala:52:19, :53:{16,37}, generators/rocket-chip/src/main/scala/util/package.scala:245:{43,53}]
  ...
  always @(posedge clock) begin
    if (reset)
      remain <= 3'h0;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceB.scala:46:25]
    else
      remain <= (remain | (_param_T_1 ? io_req_bits_clients : 3'h0)) & ~(io_b_ready & b_valid ? _GEN : 3'h0);	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceB.scala:46:25, :47:30, :48:30, :49:{23,37,39}, :53:37, :62:{24,37}, :68:21, :69:{19,32}, src/main/scala/chisel3/util/Decoupled.scala:52:35]
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        remain = _RANDOM[/*Zero width*/ 1'b0][2:0];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceB.scala:46:25]
        tag_r = _RANDOM[/*Zero width*/ 1'b0][15:3];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceB.scala:46:25, :72:52]
        set_r = _RANDOM[/*Zero width*/ 1'b0][25:16];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceB.scala:46:25, :73:52]
        param_r = _RANDOM[/*Zero width*/ 1'b0][28:26];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceB.scala:46:25, :74:56]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_b_bits_source = (_GEN[0] ? 9'h180 : 9'h0) | (_GEN[1] ? 9'h140 : 9'h0) | {_GEN[2], 8'h0};	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceB.scala:53:37, src/main/scala/chisel3/util/Mux.scala:30:73, :32:36]
