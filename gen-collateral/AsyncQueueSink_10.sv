...
module AsyncQueueSink_10(
  ...
  wire [119:0]     _io_deq_bits_deq_bits_reg_io_q;	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:207:25]
  ...
  wire [7:0][1:0]  _GEN = {{io_async_mem_7_param}, {io_async_mem_6_param}, {io_async_mem_5_param}, {io_async_mem_4_param}, {io_async_mem_3_param}, {io_async_mem_2_param}, {io_async_mem_1_param}, {io_async_mem_0_param}};	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:209:24]
  wire [7:0][5:0]  _GEN_0 = {{io_async_mem_7_source}, {io_async_mem_6_source}, {io_async_mem_5_source}, {io_async_mem_4_source}, {io_async_mem_3_source}, {io_async_mem_2_source}, {io_async_mem_1_source}, {io_async_mem_0_source}};	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:209:24]
  wire [7:0][31:0] _GEN_1 = {{io_async_mem_7_address}, {io_async_mem_6_address}, {io_async_mem_5_address}, {io_async_mem_4_address}, {io_async_mem_3_address}, {io_async_mem_2_address}, {io_async_mem_1_address}, {io_async_mem_0_address}};	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:209:24]
  ...
  ClockCrossingReg_w120 io_deq_bits_deq_bits_reg (	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:207:25]
    .clock (clock),
    .io_d  ({3'h6, _GEN[index], 4'h6, _GEN_0[index], _GEN_1[index], 73'h1FE0000000000000000}),	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:135:14, :152:55, generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:209:24]
  ...
  assign io_deq_bits_opcode = _io_deq_bits_deq_bits_reg_io_q[119:117];	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:207:25, :211:26]
  assign io_deq_bits_param = _io_deq_bits_deq_bits_reg_io_q[116:115];	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:207:25, :211:26]
