...
module ram_32x55(	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  input  [4:0]  R0_addr,
  input         R0_en,
                R0_clk,
  output [54:0] R0_data,
  ...
  reg [54:0] Memory[0:31];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
    ...
    initial begin	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
      ...
      `ifdef RANDOMIZE_MEM_INIT	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
        for (logic [5:0] i = 6'h0; i < 6'h20; i += 6'h1) begin
          ...
          Memory[i[4:0]] = _RANDOM_MEM[54:0];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
        end	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
      `endif // RANDOMIZE_MEM_INIT
    end // initial
