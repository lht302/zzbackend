...
module TLRAM(
  ...
  reg  [7:0]  r_source;	// @[generators/rocket-chip/src/main/scala/tilelink/SRAM.scala:125:26]
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        r_full = _RANDOM[4'h5][26];	// @[generators/rocket-chip/src/main/scala/tilelink/SRAM.scala:121:30]
        r_size = _RANDOM[4'h6][2:1];	// @[generators/rocket-chip/src/main/scala/tilelink/SRAM.scala:124:26]
        r_source = _RANDOM[4'h6][10:3];	// @[generators/rocket-chip/src/main/scala/tilelink/SRAM.scala:124:26, :125:26]
        r_read = _RANDOM[4'h6][11];	// @[generators/rocket-chip/src/main/scala/tilelink/SRAM.scala:124:26, :126:26]
        REG = _RANDOM[4'h9][20];	// @[generators/rocket-chip/src/main/scala/tilelink/SRAM.scala:308:58]
        r_0 = _RANDOM[4'h9][28:21];	// @[generators/rocket-chip/src/main/scala/tilelink/SRAM.scala:308:58, generators/rocket-chip/src/main/scala/util/package.scala:80:63]
        r_1 = {_RANDOM[4'h9][31:29], _RANDOM[4'hA][4:0]};	// @[generators/rocket-chip/src/main/scala/tilelink/SRAM.scala:308:58, generators/rocket-chip/src/main/scala/util/package.scala:80:63]
        r_2 = _RANDOM[4'hA][12:5];	// @[generators/rocket-chip/src/main/scala/util/package.scala:80:63]
        r_3 = _RANDOM[4'hA][20:13];	// @[generators/rocket-chip/src/main/scala/util/package.scala:80:63]
        r_4 = _RANDOM[4'hA][28:21];	// @[generators/rocket-chip/src/main/scala/util/package.scala:80:63]
        r_5 = {_RANDOM[4'hA][31:29], _RANDOM[4'hB][4:0]};	// @[generators/rocket-chip/src/main/scala/util/package.scala:80:63]
        r_6 = _RANDOM[4'hB][12:5];	// @[generators/rocket-chip/src/main/scala/util/package.scala:80:63]
        r_7 = _RANDOM[4'hB][20:13];	// @[generators/rocket-chip/src/main/scala/util/package.scala:80:63]
      `endif // RANDOMIZE_REG_INIT
    end // initial
