...
module fifox_2(
  ...
  input  [159:0] io_in_bits,	// @[generators/rocket-chip/src/main/scala/zzguard_rr/zzzzz.scala:80:16]
  ...
  output [159:0] io_out_bits,	// @[generators/rocket-chip/src/main/scala/zzguard_rr/zzzzz.scala:80:16]
  ...
  reg  [3:0] cnt;	// @[src/main/scala/chisel3/util/Counter.scala:61:40]
  wire       _GEN = cnt == 4'h3;	// @[generators/rocket-chip/src/main/scala/zzguard_rr/zzzzz.scala:92:14, src/main/scala/chisel3/util/Counter.scala:61:40]
  always @(posedge clock) begin
    if (reset)
      cnt <= 4'h0;	// @[src/main/scala/chisel3/util/Counter.scala:61:40]
    else if (cnt == 4'h9)	// @[src/main/scala/chisel3/util/Counter.scala:61:40, :73:24]
      cnt <= 4'h0;	// @[src/main/scala/chisel3/util/Counter.scala:61:40]
    else	// @[src/main/scala/chisel3/util/Counter.scala:73:24]
      cnt <= cnt + 4'h1;	// @[src/main/scala/chisel3/util/Counter.scala:61:40, :77:24]
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        cnt = _RANDOM[/*Zero width*/ 1'b0][3:0];	// @[src/main/scala/chisel3/util/Counter.scala:61:40]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Queue_88 q (	// @[generators/rocket-chip/src/main/scala/zzguard_rr/zzzzz.scala:86:19]
    .clock        (clock),
    .reset        (reset),
