...
module RRArbiter_2(
  ...
  wire [3:0][4:0]  _GEN_0 = {{io_in_0_bits_rd}, {io_in_2_bits_rd}, {io_in_1_bits_rd}, {io_in_0_bits_rd}};	// @[src/main/scala/chisel3/util/Arbiter.scala:55:16]
  wire [3:0][63:0] _GEN_1 = {{io_in_0_bits_data}, {io_in_2_bits_data}, {io_in_1_bits_data}, {io_in_0_bits_data}};	// @[src/main/scala/chisel3/util/Arbiter.scala:55:16]
  ...
  wire [1:0]       _GEN_2 = io_in_0_valid ? 2'h0 : io_in_1_valid ? 2'h1 : 2'h2;	// @[src/main/scala/chisel3/util/Arbiter.scala:90:41, :92:{26,35}]
  assign io_chosen_choice = ctrl_validMask_1 ? 2'h1 : ctrl_validMask_2 ? 2'h2 : _GEN_2;	// @[src/main/scala/chisel3/util/Arbiter.scala:83:76, :90:41, :92:{26,35}, :94:{24,33}]
  always @(posedge clock) begin
    if (io_out_ready & _io_out_valid_output) begin	// @[src/main/scala/chisel3/util/Arbiter.scala:55:16, src/main/scala/chisel3/util/Decoupled.scala:52:35]
      if (ctrl_validMask_1)	// @[src/main/scala/chisel3/util/Arbiter.scala:83:76]
        ctrl_validMask_grantMask_lastGrant <= 2'h1;	// @[src/main/scala/chisel3/util/Arbiter.scala:81:33, :90:41, :92:{26,35}]
      else if (ctrl_validMask_2)	// @[src/main/scala/chisel3/util/Arbiter.scala:83:76]
        ctrl_validMask_grantMask_lastGrant <= 2'h2;	// @[src/main/scala/chisel3/util/Arbiter.scala:81:33, :90:41]
  ...
  assign io_in_0_ready = ~_ctrl_T_1 & io_out_ready;	// @[src/main/scala/chisel3/util/Arbiter.scala:45:{68,78}, :74:21]
  assign io_in_1_ready = (ctrl_validMask_grantMask_1 | ~_ctrl_T_2) & io_out_ready;	// @[src/main/scala/chisel3/util/Arbiter.scala:45:{68,78}, :74:21, :82:49, :87:50]
  assign io_in_2_ready = (~ctrl_validMask_1 & ~(ctrl_validMask_grantMask_lastGrant[1]) | ~(_ctrl_T_2 | io_in_1_valid)) & io_out_ready;	// @[src/main/scala/chisel3/util/Arbiter.scala:45:{68,78}, :74:21, :81:33, :82:49, :83:76, :87:{34,50}]
