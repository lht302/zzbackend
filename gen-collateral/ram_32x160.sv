...
module ram_32x160(	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  input  [4:0]   R0_addr,
  input          R0_en,
                 R0_clk,
  ...
  reg [159:0] Memory[0:31];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
    ...
    initial begin	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
      ...
      `ifdef RANDOMIZE_MEM_INIT	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
        for (logic [5:0] i = 6'h0; i < 6'h20; i += 6'h1) begin
          ...
          Memory[i[4:0]] = _RANDOM_MEM;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
        end	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
      `endif // RANDOMIZE_MEM_INIT
    end // initial
  `endif // ENABLE_INITIAL_MEM_
  assign R0_data = R0_en ? Memory[R0_addr] : 160'bx;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
endmodule
