...
module AsyncQueueSource_8(
  ...
  output [2:0] io_async_mem_0_sink,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:71:14]
               io_async_mem_1_sink,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:71:14]
               io_async_mem_2_sink,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:71:14]
               io_async_mem_3_sink,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:71:14]
               io_async_mem_4_sink,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:71:14]
               io_async_mem_5_sink,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:71:14]
               io_async_mem_6_sink,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:71:14]
               io_async_mem_7_sink,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:71:14]
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        mem_0_sink = _RANDOM[1'h0][2:0];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
        mem_1_sink = _RANDOM[1'h0][5:3];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
        mem_2_sink = _RANDOM[1'h0][8:6];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
        mem_3_sink = _RANDOM[1'h0][11:9];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
        mem_4_sink = _RANDOM[1'h0][14:12];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
        mem_5_sink = _RANDOM[1'h0][17:15];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
        mem_6_sink = _RANDOM[1'h0][20:18];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
        mem_7_sink = _RANDOM[1'h0][23:21];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
        widx_widx_bin = _RANDOM[1'h0][27:24];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:52:25, :80:16]
        ready_reg = _RANDOM[1'h0][28];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16, :88:56]
        widx_gray = {_RANDOM[1'h0][31:29], _RANDOM[1'h1][0]};	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16, :91:55]
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        widx_widx_bin = 4'h0;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:52:25, :53:23]
        ready_reg = 1'h0;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:88:56]
