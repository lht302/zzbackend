...
module Queue_158(
  ...
  wire [54:0] _ram_ext_R0_data;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  ...
  ram_16x55 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
    ...
    .W0_clk  (clock),
    .W0_data ({7'h0, io_enq_bits_addr, 8'h3})	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14, :274:95]
  );
  assign io_deq_valid = ~empty;	// @[src/main/scala/chisel3/util/Decoupled.scala:279:25, :303:19]
  assign io_deq_bits_tag = _ram_ext_R0_data[7:0];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_addr = _ram_ext_R0_data[47:8];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
