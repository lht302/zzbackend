...
module Queue_88(
  ...
  input  [159:0] io_enq_bits,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  ...
  output [159:0] io_deq_bits,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        enq_ptr_value = _RANDOM[/*Zero width*/ 1'b0][4:0];	// @[src/main/scala/chisel3/util/Counter.scala:61:40]
        deq_ptr_value = _RANDOM[/*Zero width*/ 1'b0][9:5];	// @[src/main/scala/chisel3/util/Counter.scala:61:40]
        maybe_full = _RANDOM[/*Zero width*/ 1'b0][10];	// @[src/main/scala/chisel3/util/Counter.scala:61:40, src/main/scala/chisel3/util/Decoupled.scala:277:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  ram_32x160 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
