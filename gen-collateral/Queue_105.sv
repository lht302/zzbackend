...
module Queue_105(
  ...
  input  [39:0] io_enq_bits_addr,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  input  [8:0]  io_enq_bits_tag,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  input  [4:0]  io_enq_bits_cmd,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  input  [1:0]  io_enq_bits_size,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  input         io_enq_bits_signed,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  input  [1:0]  io_enq_bits_dprv,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  input         io_enq_bits_dv,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
                io_enq_bits_phys,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
                io_enq_bits_no_alloc,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
                io_enq_bits_no_xcpt,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  input  [4:0]  io_enq_bits_sdq_id,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  ...
  output [39:0] io_deq_bits_addr,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  output [8:0]  io_deq_bits_tag,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  output [4:0]  io_deq_bits_cmd,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  output [1:0]  io_deq_bits_size,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  output        io_deq_bits_signed,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  output [1:0]  io_deq_bits_dprv,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  output        io_deq_bits_dv,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  output [4:0]  io_deq_bits_sdq_id	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
);

  wire [64:0] _ram_ext_R0_data;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  ...
  mem_16x65 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_sdq_id, io_enq_bits_dv, io_enq_bits_dprv, io_enq_bits_signed, io_enq_bits_size, io_enq_bits_cmd, io_enq_bits_tag, io_enq_bits_addr})	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  );
  ...
  assign io_deq_bits_addr = _ram_ext_R0_data[39:0];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_tag = _ram_ext_R0_data[48:40];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_cmd = _ram_ext_R0_data[53:49];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_size = _ram_ext_R0_data[55:54];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_signed = _ram_ext_R0_data[56];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_dprv = _ram_ext_R0_data[58:57];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_dv = _ram_ext_R0_data[59];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_sdq_id = _ram_ext_R0_data[64:60];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
endmodule
