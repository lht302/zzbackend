...
module AsyncQueueSink_17(
  ...
  output       io_deq_bits_ackhavereset,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:135:14]
               io_deq_bits_hasel,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:135:14]
               io_deq_bits_hamask_0,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:135:14]
               io_deq_bits_hamask_1,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:135:14]
               io_deq_bits_hamask_2,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:135:14]
               io_deq_bits_hrmask_0,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:135:14]
               io_deq_bits_hrmask_1,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:135:14]
               io_deq_bits_hrmask_2,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:135:14]
  ...
  input        io_async_mem_0_ackhavereset,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:135:14]
               io_async_mem_0_hasel,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:135:14]
               io_async_mem_0_hamask_0,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:135:14]
               io_async_mem_0_hamask_1,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:135:14]
               io_async_mem_0_hamask_2,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:135:14]
               io_async_mem_0_hrmask_0,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:135:14]
               io_async_mem_0_hrmask_1,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:135:14]
               io_async_mem_0_hrmask_2,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:135:14]
  ...
  wire [18:0] _io_deq_bits_deq_bits_reg_io_q;	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:207:25]
  ...
  AsyncResetSynchronizerShiftReg_w1_d3_i0_120 widx_widx_gray (	// @[generators/rocket-chip/src/main/scala/util/ShiftReg.scala:45:23]
    .clock (clock),
    .reset (reset),
    .io_d  (io_async_widx),
    .io_q  (_widx_widx_gray_io_q)
  );
  ClockCrossingReg_w19 io_deq_bits_deq_bits_reg (	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:207:25]
    .clock (clock),
    .io_d  ({io_async_mem_0_resumereq, io_async_mem_0_hartsel, io_async_mem_0_ackhavereset, io_async_mem_0_hasel, io_async_mem_0_hamask_2, io_async_mem_0_hamask_1, io_async_mem_0_hamask_0, io_async_mem_0_hrmask_2, io_async_mem_0_hrmask_1, io_async_mem_0_hrmask_0}),	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:209:24]
  ...
  assign io_deq_bits_resumereq = _io_deq_bits_deq_bits_reg_io_q[18];	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:207:25, :211:26]
  assign io_deq_bits_hartsel = _io_deq_bits_deq_bits_reg_io_q[17:8];	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:207:25, :211:26]
  assign io_deq_bits_ackhavereset = _io_deq_bits_deq_bits_reg_io_q[7];	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:207:25, :211:26]
  assign io_deq_bits_hasel = _io_deq_bits_deq_bits_reg_io_q[6];	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:207:25, :211:26]
  assign io_deq_bits_hamask_0 = _io_deq_bits_deq_bits_reg_io_q[3];	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:207:25, :211:26]
  assign io_deq_bits_hamask_1 = _io_deq_bits_deq_bits_reg_io_q[4];	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:207:25, :211:26]
  assign io_deq_bits_hamask_2 = _io_deq_bits_deq_bits_reg_io_q[5];	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:207:25, :211:26]
  ...
  assign io_deq_bits_hrmask_1 = _io_deq_bits_deq_bits_reg_io_q[1];	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:207:25, :211:26]
  assign io_deq_bits_hrmask_2 = _io_deq_bits_deq_bits_reg_io_q[2];	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:207:25, :211:26]
