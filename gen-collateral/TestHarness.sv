...
module TestHarness(
  ...
  `ifndef SYNTHESIS	// @[generators/rocket-chip/src/main/scala/devices/debug/Periphery.scala:233:11]
    always @(posedge _source_2_clk) begin	// @[generators/chipyard/src/main/scala/harness/HarnessClocks.scala:70:26, generators/rocket-chip/src/main/scala/devices/debug/Periphery.scala:233:11]
  ...
  `endif // not def SYNTHESIS
  Zzzzz_Imp zzzzz_3 (	// @[generators/rocket-chip/src/main/scala/tile/RocketTile.scala:106:23]
    .clock  (clock),
    .reset  (reset),
    .io_out (/* unused */)
  );
  Zzzzz_Imp zzzzz_3_1 (	// @[generators/rocket-chip/src/main/scala/tile/RocketTile.scala:106:23]
    .clock  (clock),
    .reset  (reset),
    .io_out (/* unused */)
  );
  Zzzzz_Imp zzzzz_3_2 (	// @[generators/rocket-chip/src/main/scala/tile/RocketTile.scala:106:23]
    .clock  (clock),
    .reset  (reset),
    .io_out (/* unused */)
  );
  ChipTop chiptop0 (	// @[generators/chipyard/src/main/scala/harness/HasHarnessInstantiators.scala:87:40]
    ...
    .clock_tileClockGroup_rockettile_0 (_source_clk),	// @[generators/chipyard/src/main/scala/harness/HarnessClocks.scala:70:26]
    .clock_tileClockGroup_rockettile_1 (_source_1_clk),	// @[generators/chipyard/src/main/scala/harness/HarnessClocks.scala:70:26]
    .clock_tileClockGroup_rockettile_2 (_source_1_clk),	// @[generators/chipyard/src/main/scala/harness/HarnessClocks.scala:70:26]
    .clock_tap                         (/* unused */),
