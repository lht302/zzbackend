...
module SimpleHellaCacheIFReplayQueue_1(
  input         clock,
                reset,
  ...
  wire [8:0]  _GEN = _nackq_io_deq_bits ? reqs_1_tag : reqs_0_tag;	// @[generators/rocket-chip/src/main/scala/rocket/SimpleHellaCacheIF.scala:35:17, :44:21, :56:18]
  ...
  wire [8:0]  _GEN_0 = {3'h0, io_nack_bits};	// @[generators/rocket-chip/src/main/scala/rocket/SimpleHellaCacheIF.scala:62:40]
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        reqs_0_tag = _RANDOM[4'h1][18:10];	// @[generators/rocket-chip/src/main/scala/rocket/SimpleHellaCacheIF.scala:35:17]
        reqs_0_cmd = _RANDOM[4'h1][23:19];	// @[generators/rocket-chip/src/main/scala/rocket/SimpleHellaCacheIF.scala:35:17]
        reqs_0_size = _RANDOM[4'h1][25:24];	// @[generators/rocket-chip/src/main/scala/rocket/SimpleHellaCacheIF.scala:35:17]
        reqs_0_signed = _RANDOM[4'h1][26];	// @[generators/rocket-chip/src/main/scala/rocket/SimpleHellaCacheIF.scala:35:17]
        reqs_0_dprv = _RANDOM[4'h1][28:27];	// @[generators/rocket-chip/src/main/scala/rocket/SimpleHellaCacheIF.scala:35:17]
        reqs_0_dv = _RANDOM[4'h1][29];	// @[generators/rocket-chip/src/main/scala/rocket/SimpleHellaCacheIF.scala:35:17]
        reqs_0_phys = _RANDOM[4'h1][30];	// @[generators/rocket-chip/src/main/scala/rocket/SimpleHellaCacheIF.scala:35:17]
        reqs_0_data = {_RANDOM[4'h2][31:1], _RANDOM[4'h3], _RANDOM[4'h4][0]};	// @[generators/rocket-chip/src/main/scala/rocket/SimpleHellaCacheIF.scala:35:17]
        reqs_0_mask = _RANDOM[4'h4][8:1];	// @[generators/rocket-chip/src/main/scala/rocket/SimpleHellaCacheIF.scala:35:17]
        reqs_1_addr = {_RANDOM[4'h4][31:9], _RANDOM[4'h5][16:0]};	// @[generators/rocket-chip/src/main/scala/rocket/SimpleHellaCacheIF.scala:35:17]
        reqs_1_tag = _RANDOM[4'h5][25:17];	// @[generators/rocket-chip/src/main/scala/rocket/SimpleHellaCacheIF.scala:35:17]
        reqs_1_cmd = _RANDOM[4'h5][30:26];	// @[generators/rocket-chip/src/main/scala/rocket/SimpleHellaCacheIF.scala:35:17]
        reqs_1_size = {_RANDOM[4'h5][31], _RANDOM[4'h6][0]};	// @[generators/rocket-chip/src/main/scala/rocket/SimpleHellaCacheIF.scala:35:17]
        reqs_1_signed = _RANDOM[4'h6][1];	// @[generators/rocket-chip/src/main/scala/rocket/SimpleHellaCacheIF.scala:35:17]
        reqs_1_dprv = _RANDOM[4'h6][3:2];	// @[generators/rocket-chip/src/main/scala/rocket/SimpleHellaCacheIF.scala:35:17]
        reqs_1_dv = _RANDOM[4'h6][4];	// @[generators/rocket-chip/src/main/scala/rocket/SimpleHellaCacheIF.scala:35:17]
        reqs_1_phys = _RANDOM[4'h6][5];	// @[generators/rocket-chip/src/main/scala/rocket/SimpleHellaCacheIF.scala:35:17]
        reqs_1_data = {_RANDOM[4'h6][31:8], _RANDOM[4'h7], _RANDOM[4'h8][7:0]};	// @[generators/rocket-chip/src/main/scala/rocket/SimpleHellaCacheIF.scala:35:17]
        reqs_1_mask = _RANDOM[4'h8][15:8];	// @[generators/rocket-chip/src/main/scala/rocket/SimpleHellaCacheIF.scala:35:17]
        replaying = _RANDOM[4'h8][16];	// @[generators/rocket-chip/src/main/scala/rocket/SimpleHellaCacheIF.scala:35:17, :45:26]
      `endif // RANDOMIZE_REG_INIT
    end // initial
