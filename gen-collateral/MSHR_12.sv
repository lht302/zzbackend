...
module MSHR_12(
  ...
  input  [7:0]  io_req_bits_tag,	// @[generators/rocket-chip/src/main/scala/rocket/NBDcache.scala:145:14]
  ...
  output [7:0]  io_replay_bits_tag,	// @[generators/rocket-chip/src/main/scala/rocket/NBDcache.scala:145:14]
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_cmd = _RANDOM[2'h1][24:20];	// @[generators/rocket-chip/src/main/scala/rocket/NBDcache.scala:170:16]
        req_old_meta_coh_state = _RANDOM[2'h2][9:8];	// @[generators/rocket-chip/src/main/scala/rocket/NBDcache.scala:170:16]
        req_old_meta_tag = _RANDOM[2'h2][29:10];	// @[generators/rocket-chip/src/main/scala/rocket/NBDcache.scala:170:16]
        req_way_en = {_RANDOM[2'h2][31:30], _RANDOM[2'h3][1:0]};	// @[generators/rocket-chip/src/main/scala/rocket/NBDcache.scala:170:16]
        new_coh_state = _RANDOM[2'h3][3:2];	// @[generators/rocket-chip/src/main/scala/rocket/NBDcache.scala:170:16, :176:24]
        counter = _RANDOM[2'h3][12:4];	// @[generators/rocket-chip/src/main/scala/rocket/NBDcache.scala:170:16, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:230:27]
        acked = _RANDOM[2'h3][13];	// @[generators/rocket-chip/src/main/scala/rocket/NBDcache.scala:170:16, :199:18]
        meta_hazard = _RANDOM[2'h3][15:14];	// @[generators/rocket-chip/src/main/scala/rocket/NBDcache.scala:170:16, :272:28]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Queue_54 rpq (	// @[generators/rocket-chip/src/main/scala/rocket/NBDcache.scala:194:19]
    .clock                (clock),
    .reset                (reset),
  ...
  assign io_replay_bits_cmd = io_meta_read_ready ? _rpq_io_deq_bits_cmd : 5'h5;	// @[generators/rocket-chip/src/main/scala/rocket/NBDcache.scala:194:19, :285:25, :305:18, :309:30, :311:24]
