...
module UARTAdapter(
  ...
  UARTRx txm (	// @[generators/testchipip/src/main/scala/uart/SimUART.scala:35:19]
    ...
    .io_div       (16'h364)	// @[generators/testchipip/src/main/scala/uart/SimUART.scala:45:14]
  );
  Queue_205 txq (	// @[generators/testchipip/src/main/scala/uart/SimUART.scala:36:19]
    .clock        (clock),
    .reset        (reset),
  ...
  Queue_205 rxq (	// @[generators/testchipip/src/main/scala/uart/SimUART.scala:38:19]
    .clock        (clock),
    .reset        (reset),
